// Capture butterflies during the day (peak hour ~12:00).
...
const out = process.argv[2] ?? '/tmp/butterflies.png';
...
const log = (...a) => console.error('[butterflies]', ...a);
...
await ev('window.__sim.setSpeed(0)');  // pause so tick doesn't drift
await wait(500);

// Zoom into a forest clearing
await ev(`(() => {

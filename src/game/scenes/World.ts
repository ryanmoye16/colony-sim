...
export class World extends Scene
{
    ...
    create ()
    {
        ...
        // Butterflies — small colorful critters that drift across grass
        // clearings during the day. World-anchored so they stay put as the
        // camera pans. Visibility scales with hour-of-day.
        this.butterflies = new Butterflies(this, this.world, WORLD_SEED);
    ...
    update (_time: number, delta: number): void
    {
        ...
        if (this.butterflies && this.sim && this.atmosphere)
        {
            const hour = Atmosphere.hourFromTick(this.sim.tick);
            this.butterflies.update(this.sim.tick * 1000, hour, delta);
        }
    ...
    private loadFromSave (): void
    {
        ...
        this.motes?.destroy();
        this.motes = new Motes(this, this.world.width, this.world.height, WORLD_SEED);
        // Butterflies — re-seed so the population redistributes.
        this.butterflies?.destroy();
        this.butterflies = new Butterflies(this, this.world, WORLD_SEED);
